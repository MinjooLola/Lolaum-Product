    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="max-w-6xl mx-auto flex h-14 items-center justify-between gap-4 px-4">
        ...
        <div className="hidden md:block">
          <Link href="/apply">
            <Button size="sm" data-testid="nav-button-apply">
              신청하기
            </Button>
          </Link>
        </div>
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="right" className="w-64">
            <div className="flex flex-col gap-4 mt-8">
              ...
              <Link href="/apply">
                <Button className="w-full mt-4" onClick={() => setOpen(false)} data-testid="mobile-nav-button-apply">
                  신청하기
                </Button>
              </Link>
            </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">롤라움</span>
          </div>
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <a 
              href="https://pf.kakao.com/_xoLxaG" 
              target="_blank" 
