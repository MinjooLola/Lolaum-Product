        ...
        <div className="max-w-3xl mx-auto space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed break-keep">
              일을 잘해내느라 바쁜 사람들이 회사 밖의 나를 다시 돌보는 연습을 함께하는 커뮤니티입니다.
            </p>
            <p className="text-muted-foreground leading-relaxed break-keep">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed break-keep">
              건강한 루틴을 만들고자 하는 많은 사람들이 "조금만 여유가 생기면 다시 챙기면 되지"라고 말하지만, 현실에서는 그 '나중'이 쉽게 오지 않습니다. 일상을 돌보는 방식은 저절로 생기지 않기 때문입니다.
            </p>
            <p className="text-muted-foreground leading-relaxed break-keep">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex items-start gap-2 break-keep">
                ...
                <span>목표를 증명하는 곳이 아니라 상태를 점검하는 공간</span>
              </li>
              <li className="flex items-start gap-2 break-keep">
                <span className="shrink-0">•</span>
                <span>완벽한 루틴이 아니라 지속 가능한 리듬을 만드는 곳</span>
              </li>
              <li className="flex items-start gap-2 break-keep">
                <span className="shrink-0">•</span>
                <span>혼자서 애쓰지 않고 느슨하게 연결되는 커뮤니티</span>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                <li key={idx} className="p-3 border rounded-md text-center break-keep">{item}</li>
              ))}
            </ul>
          </div>
          ...
          <Card className="bg-primary/5 border-primary/20 mt-12">
            <CardContent className="p-8 text-center space-y-6">
              ...
              <p className="text-muted-foreground break-keep">
                리추얼클럽은 회사 밖의 나를 회복하며, 일상을 건강하게 설계해가고 싶은 모든 분들에게 열려 있는 커뮤니티입니다.
              </p>
              <p className="text-muted-foreground break-keep">
