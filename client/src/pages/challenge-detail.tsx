...
const challengesData: Record<string, ChallengeData> = {
  ...
  "spanish": {
    slug: "spanish",
    title: "스페인어리추얼챌린지",
    subtitle: "다시 시작한 언어를 일상에 고정하는 챌린지",
    icon: Languages,
    description: "스페인어리추얼챌린지는 예전에 배웠지만 손에서 놓아버린 언어를 다시 일상으로 불러오는 챌린지입니다.\n\n짧게라도 자주 접하며 언어 감각을 유지하고, '언젠가 다시'가 아니라 '지금도 하고 있다'는 상태를 만드는 것이 목표입니다.",
    details: [
      "주 5회 10분 이상",
      "학습 방식 자유",
      "꾸준함 중심 설계"
  ...
  "writing": {
    slug: "writing",
    title: "기록리추얼챌린지",
    subtitle: "감정을 흘려보내지 않고, 기록으로 나를 회복하는 시간",
    icon: PenLine,
    description: "기록리추얼챌린지는 잘 쓰는 글이 아니라 계속 쓰는 사람이 되는 데 목적이 있습니다.\n\n매일 짧은 글을 쓰며 감정과 생각을 쌓아두지 않고 흘려보내는 경험을 통해 나를 이해하는 힘을 기릅니다.",
    details: [
      "주 5회 글쓰기",
      "주 2회는 글 읽기로 대체 가능",
      "양보다 지속과 솔직함에 집중"
