...
const reviews = [
  ...
  },
  {
    id: 4,
    authorName: "쨈",
    content: "내가 지금 무언가 바꾸고 싶다면, 더 나아지고 싶은 어떤 방향이 있다면, 혹은 그 방향을 알고 싶다면, 새로운 경험을 하거나 책을 읽거나 둘 중 하나는 꼭 해야 한다고 생각해요. 저는 매일 읽는 책이 제 인생을 바꾸고 있다고 확신합니다.",
    ...
    <div className="min-h-screen py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {reviews.map((review) => (
            <Card key={review.id} className="border-l-4 border-l-primary rounded-l-none" data-testid={`card-review-${review.id}`}>
